...
public class ClerkstateGUI extends JFrame {
	...
	public ClerkstateGUI() {
		...
		btnNewButton_4.setIcon(new ImageIcon(ClerkstateGUI.class.getResource("/iconimages/cancel.png")));
		...
		btnSave.setIcon(new ImageIcon(ClerkstateGUI.class.getResource("/iconimages/save.png")));
